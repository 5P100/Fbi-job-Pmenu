Locales['fr'] = {
  ...
  -- Ordinateur
  ['open_ordinateur'] = 'appuyez sur ~INPUT_CONTEXT~ pour ~g~utiliser~s~ l\'ordinateur',
  -- Elevator
  ['elevator'] = 'ascenseur',
  ['elevator_top'] = 'aller dans les bureaux',
  ['elevator_down'] = 'aller au rez de chaussée',
  ['elevator_parking'] = 'aller au parking',
  ['open_elevator'] = 'appuyez sur ~INPUT_CONTEXT~ pour pendre ~g~l\'ascenseur~s~',
  -- Armory
  ...
  -- Vehicles
  ['range_vehicule'] = 'Appuyez sur ~INPUT_CONTEXT~ pour ~g~ranger~s~ le véhicule',
  ...
  ['phone_fbi'] = 'fbi',
  ['menu_accueil'] = 'Appuyez sur ~INPUT_CONTEXT~ pour ~g~Parler~s~ à la secrétaire',
}